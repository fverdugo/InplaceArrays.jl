...
#import InplaceArrays.ReferenceFEs: vertex_permutations
#import Base: ==
#
#import InplaceArrays.ReferenceFEs: compute_monomial_basis
#import InplaceArrays.ReferenceFEs: compute_interior_nodes
#import InplaceArrays.ReferenceFEs: compute_face_orders
#
## Helper private type
...
#end
#
#function compute_face_orders(p::SerendipityPolytope{D},face::SerendipityPolytope{N},iface::Int,orders) where {D,N}
